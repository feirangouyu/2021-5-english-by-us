$("body").on("mousemove",".sliderContainer",sliderMove);
$("body").on("mouseout",".sliderContainer",sliderOut);
...
(function(window) {
    ...
    function getRandomImg() {
        return './images/image' + getRandomNumberByRange(1, 3) + '.jpg'
    }
...
jigsaw.init(document.getElementById('captcha'), function() {
    window.$ckboxSucces = true;
    $("body").unbind("mousemove",sliderMove);
    $(".login-account p").css("display","none");
})
